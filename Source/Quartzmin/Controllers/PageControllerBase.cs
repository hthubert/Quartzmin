...
namespace Quartzmin.Controllers
{
    public abstract partial class PageControllerBase : Microsoft.AspNetCore.Mvc.ControllerBase
    {
        ...
        protected IActionResult Json(object content) => new JsonResult(content, SerializerSettings);
    ...
    public abstract partial class PageControllerBase
    {
        ...
        {
            var content = Services.ViewEngine
                .Render($"{GetRouteData("controller")}/{viewName}.hbs", new Page(this, model));
            return Html(content);
        }
